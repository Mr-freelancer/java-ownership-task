...
class ReminderAccessServiceTest {
    ...
    private final ReminderAccessService accessService = new ReminderAccessService(fileRepository, userRepository);
    ...
    public void getCountPossibleInsertsBigRemainder() {
        ...
        Assertions.assertEquals( 2, accessService.getNumberPossibleAccess(userRepository.getById(0)));
        Assertions.assertEquals( 2, accessService.getNumberPossibleAccess(userRepository.getById(1)));
        Assertions.assertEquals( 2, accessService.getNumberPossibleAccess(userRepository.getById(2)));
        Assertions.assertEquals( 2, accessService.getNumberPossibleAccess(userRepository.getById(3)));
        Assertions.assertEquals( 2, accessService.getNumberPossibleAccess(userRepository.getById(4)));
        Assertions.assertEquals( 2, accessService.getNumberPossibleAccess(userRepository.getById(5)));
        Assertions.assertEquals( 2, accessService.getNumberPossibleAccess(userRepository.getById(6)));
        Assertions.assertEquals( 2, accessService.getNumberPossibleAccess(userRepository.getById(7)));
        Assertions.assertEquals( 2, accessService.getNumberPossibleAccess(userRepository.getById(8)));
        Assertions.assertEquals( 2, accessService.getNumberPossibleAccess(userRepository.getById(9)));
        ...
        Assertions.assertEquals(0, accessService.getNumberPossibleAccess(userRepository.getById(0)));
        ...
        Assertions.assertEquals(0, accessService.getNumberPossibleAccess(userRepository.getById(1)));
        ...
        Assertions.assertEquals(1, accessService.getNumberPossibleAccess(userRepository.getById(5)));
        userRepository.getById(5).takeOwnershipFiles(fileRepository.getById(11));

        // Check users for ownership
        Assertions.assertEquals(0, accessService.getNumberPossibleAccess(userRepository.getById(0)));
        Assertions.assertEquals(0, accessService.getNumberPossibleAccess(userRepository.getById(1)));
        Assertions.assertEquals(0, accessService.getNumberPossibleAccess(userRepository.getById(2)));
        Assertions.assertEquals(0, accessService.getNumberPossibleAccess(userRepository.getById(3)));
        Assertions.assertEquals(0, accessService.getNumberPossibleAccess(userRepository.getById(4)));
        Assertions.assertEquals(0, accessService.getNumberPossibleAccess(userRepository.getById(5)));

        Assertions.assertEquals(1, accessService.getNumberPossibleAccess(userRepository.getById(6)));
        userRepository.getById(6).takeOwnershipFiles(fileRepository.getById(12));
        Assertions.assertEquals(0, accessService.getNumberPossibleAccess(userRepository.getById(6)));

        Assertions.assertEquals(1, accessService.getNumberPossibleAccess(userRepository.getById(7)));
        userRepository.getById(7).takeOwnershipFiles(fileRepository.getById(13));
        Assertions.assertEquals(0, accessService.getNumberPossibleAccess(userRepository.getById(7)));

        Assertions.assertEquals(1, accessService.getNumberPossibleAccess(userRepository.getById(8)));
        userRepository.getById(8).takeOwnershipFiles(fileRepository.getById(14));
        Assertions.assertEquals(0, accessService.getNumberPossibleAccess(userRepository.getById(8)));

        Assertions.assertEquals(1, accessService.getNumberPossibleAccess(userRepository.getById(9)));
        userRepository.getById(9).takeOwnershipFiles(fileRepository.getById(15));
        Assertions.assertEquals(0, accessService.getNumberPossibleAccess(userRepository.getById(9)));
    ...
    public void getCountPossibleInsertsSmallRemainder() {
        ...
        for (int i = 0; i < userRepository.getAll().size(); i++) {
            Assertions.assertEquals(2, accessService.getNumberPossibleAccess(userRepository.getById(i)));
        }

        // User1
        userRepository.getById(0).takeOwnershipFiles(fileRepository.getById(0));
        Assertions.assertEquals(1, accessService.getNumberPossibleAccess(userRepository.getById(0)));
        userRepository.getById(0).takeOwnershipFiles(fileRepository.getById(1));
        Assertions.assertEquals(0, accessService.getNumberPossibleAccess(userRepository.getById(0)));

        // User2
        userRepository.getById(1).takeOwnershipFiles(fileRepository.getById(2));
        Assertions.assertEquals(1, accessService.getNumberPossibleAccess(userRepository.getById(1)));
        userRepository.getById(1).takeOwnershipFiles(fileRepository.getById(3));
        Assertions.assertEquals(0, accessService.getNumberPossibleAccess(userRepository.getById(1)));
        ...
        // User5
        userRepository.getById(4).takeOwnershipFiles(fileRepository.getById(8));
        Assertions.assertEquals(1, accessService.getNumberPossibleAccess(userRepository.getById(4)));
        userRepository.getById(4).takeOwnershipFiles(fileRepository.getById(9));
        ...
        Assertions.assertEquals(1, accessService.getNumberPossibleAccess(userRepository.getById(0)));
        Assertions.assertEquals(1, accessService.getNumberPossibleAccess(userRepository.getById(1)));
        Assertions.assertEquals(1, accessService.getNumberPossibleAccess(userRepository.getById(2)));
        Assertions.assertEquals(1, accessService.getNumberPossibleAccess(userRepository.getById(3)));
        Assertions.assertEquals(1, accessService.getNumberPossibleAccess(userRepository.getById(4)));
        Assertions.assertEquals(1, accessService.getNumberPossibleAccess(userRepository.getById(5)));
        Assertions.assertEquals(1, accessService.getNumberPossibleAccess(userRepository.getById(6)));
